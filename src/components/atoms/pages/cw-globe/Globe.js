...
import basecolor from "../../../../assets/cw-globe/color.jpg";
import height from "../../../../assets/cw-globe/height.jpg";
import clouds from "../../../../assets/cw-globe/clouds.png";
...
function Globe() {
  ...
  return (
    <group ref={groupRef}>
      ...
      <mesh ref={cloudsRef} scale={5.005}>
        <sphereBufferGeometry args={[1, 128, 128]} />
        <meshBasicMaterial
          transparent={true}
